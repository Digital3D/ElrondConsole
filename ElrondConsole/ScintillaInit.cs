...
namespace ElrondConsole
{
    class ScintillaInit
    {
        ...
        public ScintillaInit(Form form, Scintilla textArea)
        {
            TextArea = textArea;
            _form = form;
        ...
        private void InitHotkeys()
        {
            ...
            HotKeyManager.AddHotKey(_form, OpenSearch, Keys.F, true);
            HotKeyManager.AddHotKey(_form, OpenFindDialog, Keys.F, true, false, true);
            HotKeyManager.AddHotKey(_form, OpenReplaceDialog, Keys.R, true);
            HotKeyManager.AddHotKey(_form, OpenReplaceDialog, Keys.H, true);
            HotKeyManager.AddHotKey(_form, Uppercase, Keys.U, true);
            HotKeyManager.AddHotKey(_form, Lowercase, Keys.L, true);
            HotKeyManager.AddHotKey(_form, ZoomIn, Keys.Oemplus, true);
            HotKeyManager.AddHotKey(_form, ZoomOut, Keys.OemMinus, true);
            HotKeyManager.AddHotKey(_form, ZoomDefault, Keys.D0, true);
            HotKeyManager.AddHotKey(_form, CloseSearch, Keys.Escape);
        ...
        private void InitSyntaxColoring()
        {
            ...
            TextArea.Styles[Style.Json.BlockComment].ForeColor = Color.FromArgb(0, 128, 0); // Green
            TextArea.Styles[Style.Json.LineComment].ForeColor = Color.FromArgb(0, 128, 0); // Green
            TextArea.Styles[Style.Json.Number].ForeColor = Color.White;
            TextArea.Styles[Style.Json.PropertyName].ForeColor = Color.FromArgb(180, 203, 255);
            TextArea.Styles[Style.Json.String].ForeColor = Color.FromArgb(237, 255, 91); // Red
            TextArea.Styles[Style.Json.StringEol].BackColor = Color.FromArgb(255, 232, 149);
            TextArea.Styles[Style.Json.Operator].ForeColor = Color.FromArgb(161, 190, 255);
            TextArea.Styles[Style.Json.EscapeSequence].ForeColor = Color.FromArgb(161, 255, 162);
            TextArea.Styles[Style.Json.Error].ForeColor = Color.FromArgb(248, 51, 138);
            TextArea.Styles[Style.Json.Number].ForeColor = Color.FromArgb(248, 156, 51);
            TextArea.Lexer = Lexer.Json;

            //if (_lexer == Lexer.Sql)
            //{
            //    TextArea.SetKeywords(0, "select from where group by having on drop delete update set declare int integer datetime nvarchar varchar char timestamp date");
            //    TextArea.SetKeywords(1, "inner join left right exec");
            //    TextArea.SetKeywords(2, "getdate");
            //}
